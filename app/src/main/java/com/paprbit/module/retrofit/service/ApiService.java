...
public interface ApiService {
    ...
    @FormUrlEncoded
    @POST("services/register-operator.php")
    Call<Message> registerUser( @Field("email") String email, @Field("pid") String pid,@Field("password") String password);
    ...
    @FormUrlEncoded
    @POST("services/get-requests-pid.php")
    Call<List<RequestData>> getRequestByUid(@Field("pid") String pid);
    ...
    @FormUrlEncoded
    @POST("services/change-status.php")
    Call<Message> changeStatus(@Field("status") String status);
/*
