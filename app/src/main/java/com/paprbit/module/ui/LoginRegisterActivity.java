...
public class LoginRegisterActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    @Bind(R.id.et_pid_register)
    EditText etPidRegister;
    ...
    private void register() {
        ...
        Call<Message> call = ServiceGenerator.getService().registerUser( etEmailRegister.getText().toString(), etPidRegister.getText().toString(),etPassRegister.getText().toString()); //retrofit service call
